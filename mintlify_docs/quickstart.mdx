...
- Node.js 18 or later
- A ZendFi account ([sign up here](https://app.zendfi.tech))
...
<Note>
Test keys route all transactions to Solana devnet. No real money is involved. You can generate a test key from your [dashboard](https://app.zendfi.tech).
</Note>
