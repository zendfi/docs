...
title: Payment Links
description: Create shareable payment links that work anywhere - email, social media, or messaging apps. Each link generates a unique checkout page for customers.
---
